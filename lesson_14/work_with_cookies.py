...
# в файл. После этого можно пропускать процесс логина прото подгружая сохраненные куки из файла

driver.get("https://www.freeconferencecall.com/global/pl")
# ...тут мы должны выполнить логин...

# сохраним все cookies в файл (его нужно предварительно создать)
